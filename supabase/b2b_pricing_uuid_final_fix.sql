-- 1. Önce eski fonksiyonları ve triggerları temizle (Return type hatasını önlemek için)
...
drop function if exists get_b2b_list_id(); -- Kritik adım: Bunu silmezsek tip hatası verir

-- 2. price_lists tablosunda 'type' sütunu var mı kontrol et, yoksa ekle
do $$
begin
...
-- 3. App Settings Tablosu (Global Ayarlar) - Eğer yoksa
...
-- 4. B2B Fiyat Listesi ID'sini Getiren Fonksiyon (UUID Uyumlu)
...
-- 5. Trigger Fonksiyonu: TEK Ürün Fiyatı Değişince
...
-- 6. Trigger Fonksiyonu: GLOBAL Yüzde Değişince
